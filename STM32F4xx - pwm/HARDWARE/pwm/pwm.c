...
{		 					 
    ...
    GPIO_PinAFConfig(GPIOD,GPIO_PinSource12,GPIO_AF_TIM3); //GPIO复用为定时器
    GPIO_PinAFConfig(GPIOD,GPIO_PinSource13,GPIO_AF_TIM3); //GPIO复用为定时器
    GPIO_PinAFConfig(GPIOD,GPIO_PinSource14,GPIO_AF_TIM3); //GPIO复用为定时器
    GPIO_PinAFConfig(GPIOD,GPIO_PinSource15,GPIO_AF_TIM3); //GPIO复用为定时器
